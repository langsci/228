...
\newcommand{\ve}[1]{\textcolor{DarkBlue}{\textit{#1}}}		%vernacular text, dark blue colour
...
\newcommand{\tbrtb}[2]{\textcolor{DarkRed}{\it{\tbf{#1}͡\tbf{#2}}}} %tiebar over two boldface, italic, maroon letters -- for some reason the tiebar over a boldface character in Linux Libertine displays as  breve over the first character
