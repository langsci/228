...
with more examples given in \qf{ex:VCa->VVC}.
...
occur before consonants in U-forms, with 
with 31 examples in my database.
...
Examples are given in \trf{tab:RoqMforFinA} which shows
...
two identical vowels as a single (\srf{sec:DouVow}),
