...
At its most simple, metathesis involves the reversal of the final consonant-vowel sequence of a word.
...
\begin{table}[h]
	...
	\caption[M-forms of \it{muʔit} `animal' and \it{fatu} `stone']
					{M-forms of \ve{muʔit} `animal' and \ve{fatu} `stone'}\label{tab:MfoMuqAni}
