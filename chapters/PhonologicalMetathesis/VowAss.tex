...
\tsc{[+front]} of the previous vowel spread,
...
Other examples of vowel assimilation in Amarasi include:
...
Consonant insertion then takes in \qf{as:naitj=ee1}--\qf{as:naitj=ee2}
