...
such as a foot, syllable or prosodic word
...
edge between the host and encltic, as illustrated in \qf{as:tbiku=siin} below.
...
of the clitic host yielding the structure in \qf{as:muiqt=ee}
