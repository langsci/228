...
words which end in a vowel sequence.\footnote{
		...
		See \srf{sec:PosDet} more more details on this construction.}
...
all that is left of plural morpheme. I propose
that preservatin of this morpheme motivates deletion
...
Similarly, for verbs a historical trace of the allomorph
...
When a vowel initial enclitic is added such stem then undergo metathesis.
