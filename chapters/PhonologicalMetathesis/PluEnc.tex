...
of which the form \ve{=uun} the M-form of \ve{=enu}.
...
After stems which end in CV the plural enclitic usually takes the form \ve{=n}.
...
The noun \ve{kfuu} `star' forms an exception with
the plural \ve{kfuu=n} `stars' for some speakers.
...
\begin{exe}
	\ex{\glll	feʔe n-ʔoban naan rauk=\tbr{n}=\tbr{ein}, nopu nua mes ka= n-eku =f, n-ʔoobn=aah.\\
						feʔe n-ʔoban naan raku=\tbr{n}=\tbr{ein} nopu nua mes ka= n-eku =f, n-ʔobon=aah.\\
	...
	\ex{\glll	hoo m-fee areʔ kana=n hau fua-f maut he koor=\tbr{n}=\tbr{ein} bisa n-eku=n.\\
	...
	\ex{\glll	{rari =te}, n-ma-taeb n-ok ahh baroit=\tbr{n}=\tbr{ein} =ama\\
						{rari =te}, n-ma-tabe n-oka {} baroit=\tbr{n}=\tbr{ein} =ama\\
...
Vowel final stems take \ve{=n} while consonant
final stems take \ve{=ein/=eni}, or its variant \ve{=uun/=enu}.
...
Examples are given in in \qf{ex:VV=ngw=een} below.
