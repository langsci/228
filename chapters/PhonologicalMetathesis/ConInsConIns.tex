...
when the inceptive enclitic \ve{=een} occurs attached to the Indonesian loanword \it{estiga} `Ph.D., doctoral degree'.\footnote{
...
\begin{exe}
	\ex{\gll	\sf{estiga}\j=een?\\
						Ph.D={\een}\\
			\glt	`(You're) now doing a Ph.D.?' \txrf{observation}}\label{ex:estiga=jen}
\end{exe}
