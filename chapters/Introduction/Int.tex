...
has two different forms: \it{pu\tbr{re}} {\tl} \it{pu\tbr{er}}
...
as shown in \qf{ex:el. 22/02/16 p.19} below.

\begin{exe}
	\ex[*]{\gll	naiʔ Owen ina ʔpiurʔ=ee n-mo\tbr{fu}, n-mo\tbr{uf} =ma na-mneuk.\\
						{\naiq} Owen {\iin} cloth=\tsc{def} {\n}-fall {\n}-fall =and {\na}-lose\\
			\glt	`(Owen's handkerchief fell, it fell and was lost.)' \txrf{el. 22/02/16 p.19}
