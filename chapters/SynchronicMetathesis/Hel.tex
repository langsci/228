...
Examples of each relevant vowel combination are given in \qf{ex:VCV->VVC} below.\footnote{
...
In \qf{ex:KatBukuDehe} the quantifier \it{dehe} `some' occurs in the U-form
...
Compare the examples in \qf{ex:HelAsp1a}--{ex:HelAsp2b} below.
