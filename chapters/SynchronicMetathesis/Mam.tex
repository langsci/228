...
\begin{exe}
	...
	\sn{\gw\begin{tabular}{llcll}
			...
			*babuy	&\it{*ha\tbr{hi}}				&{\ra}&\it{ha\tbr{eh}}	&`pig' \\
			*hapuy	&\it{*a\tbr{fi}}				&{\ra}&\it{a\tbr{ef}}		&`fire' \\
			*tasik	&\it{*ta\tbr{si}}				&{\ra}&\it{ta\tbr{es}}	&`sea' \\
%			*	&\it{\hp{*}}	&{\ra}&\it{}	&`' \\
%			*	&\it{\hp{*}}	&{\ra}&\it{}	&`' \\
	\end{tabular}}%
\end{exe}
...
\begin{exe}
	...
	\sn{\gw\begin{tabular}{llll}
			& M-form 	& U-form 	&	\\
		`death'	&\it{ma\tbr{et}}	&\it{ma\tbr{te}}	&`die, be dead	\\
...
%XXX rename to not use ‘inalienable/alienable’
...
of earlier genitive \it{-n}.\il{Mambae|)}