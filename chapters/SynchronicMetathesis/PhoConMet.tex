...
\begin{exe}
	...
	%		\it{Bord}		&/bɔʀ\tbr{t}/		&\it{Borde}		&/bɔʀ\tbr{d}ə/	&`shelf'	\\
	...
	%		\it{Tag}		&/taː\tbr{k}/		&\it{Tage}		&/taː\tbr{ɡ}ə/	&`day'	\\
			...
			\it{brav}		&/bʀaː\tbr{f}/	&\it{brave}		&/bʀaː\tbr{v}ə/	&`well-behaved'	\\
...
A simple example of phonological metathesis is provided by \ili{Faroese} (Germanic, Faroe Islands).
...
is illustrated in \qf{as:fesk->fekst} below in which ``F'' = fricative and ``P'' = plosive.
...
As a result the addition of a consonant initial suffix
