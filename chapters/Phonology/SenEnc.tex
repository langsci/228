...
the connectors \ve{=ma} and \ve{=te}, as well as the negator enclitic \ve{=fa} and.
...
\begin{exe}
	\ex{\gll		n-reuk fanu =\tbr{te}, {\ldots} \\
							\n-pluck eight ={\te} \\
...
\begin{exe}
	...
	\ex{\glll				\hp{[}\sf{per} a|krei. {} kree\j=esa =\tbr{t}, ees.\\
							\hp{[}\sf{per} {\a}krei {} krei=esa =\tbr{te} esa\\
							\hp{[}per {\a}week {} week={\es} ={\te} {\es}\\
			\glt		\leavevmode{\hp{[}}`Per week. One (every) week.' \txrf{120923-1, 12.40}
...
\begin{exe}
	...
	\ex{\glll		ʔnakaʔ fauk =\tbr{at} nine-f esa =t hoo m-ak ``teun''\\
							ʔnakaʔ fauk =\tbr{te} nine-f esa =t hoo m-ak \hp{``}tenu\\
							head how.many ={\te} wing-{\f} one ={\te} {\hoo} \m-say \hp{``}three\\
...
\begin{exe}
	...
	\ex{\glll	kaah =te, reʔ iin na-papaʔ =ma iin n-si\tbr{ir}k =\tbr{am} \hspace{20mm} iin n-nao piut\\
						kaah =te reʔ ini na-papaʔ =ma iin n-si\tbr{ri}k =ma {} ini n-nao piut\\
	{\kaah} ={\te} {\req} {\iin} \na-wound =and {\iin} \n-spread{\tbrMv} =and {} {\iin} \n-go continue\\
			\glt	`If not, s/he is wounded and it (the wound) spreads and keeps going (i.e. growing)'
