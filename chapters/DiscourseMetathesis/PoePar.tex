...
\begin{exe}
	\ex{\glll	henatiʔ \bxA{m-te\tbr{nu}} =m \bxB{mu-ha\tbr{of}} too{\gap}tafaʔ =kai {\lks}\\
						...
						{\he} \gp\m-umbrella{\tbrU} =and \gp\mu-shade{\tbrM} citizen ={\kai}\\
...
more often the pairs are of words or phrases which mean similar things,
such as the pair \it{weeping‖crying} in verse 19.
Individually, each member of a pair may not be an exact synonym,
but when used as doublets, they are effectively synonymous.
...
\begin{exe}
	...
	\begin{xlist}
		...
		\sn{\gll	\bxA{muit} ma-hine-ʔ =ma \bxB{mnatuʔ} neee{\ldots} {\lks}\\
				...
				\glt	`Greetings and honour to all people, who are like silver and gold, wise and knowledgable silver and gold,' \txrf{0.00}}
		\ex{\gll	MA-HINE-Ɂ \\
							{\ma}-know-{\ma} \\
				\glt	`So wise.'	\txrf{0.05}}
		\ex{\gll	n-eu \bxA{a-ʔnae-t} =ma \bxB{a-mepu-t} a|n-bi Uisneno iin meupg=aa =m neee{\ldots} {\lks}\\
		...
		\ex{\gll	na-tuin \bxA{sarit} =ma \bxB{bekot} a-reok-t =aa =m neee{\ldots} {\lks}\\
							\na-follow {\gp}intention =and {\gp}plan {\at}-good-{\at} ={\aa} =and \tsc{pause}\\
				\glt	`following (His) good intentions and plans,' \txrf{0.07}}
		\ex{\gll	A-REKO-T \\
							{\at}-good-{\at}\\
...
the connector \ve{=ma} `and' occurs between each,
...
\begin{exe}
	...
	\begin{xlist}
		\ex{\glll	iin tua-n=ee ees--, ees naiʔ Bani, naiʔ Oraʔ, \\
							...
							{\iin} owner-\N={\ee} {} one {\naiq} Bani {\naiq} Ora{\Q} \\}
		\vspace{4pt}
		\sn{\glll	\bxA{n-si\tbr{mo}} =ma \bxB{n-to\tbr{up}} tuaf am-nema-t \sf{tamu} neee{\ldots} {\lks} \\
...
\begin{exe}
	...
	\begin{xlist}
		...
		\sn{\glll	hoo ʔnima-m a-ma-neka-b, {\lks}\\
							...
							`We give offerings we received from your loving hand.'}
