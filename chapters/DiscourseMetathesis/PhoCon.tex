...
\qf{130825-6, 10.05} and \qf{ex:130914-1, 0.53} below.\footnote{
...
Such examples represent only 7{\%} (21/302) of all non-nominals before a consonant cluster.
...
There are 44 instances of a consonant
final stem before a consonant cluster in my corpus.
...
\begin{exe}
	...
	\ex{\glll	iin n-mooʔ\j=oo-n on kaunʔ=ii =ma n-nono\tbr{k} \tbr{a}|\tbr{n}-peoʔ aafgw=ii =ma\\
			...
			\glt	`he did it like the snake and crawled along the ground and'
						\txrf{120715-4, 1.52} {\emb{120715-4-01-52.mp3}{\spk{}}{\apl}}}\label{ex:120715-4, 1.52}
\end{exe}

In the remaining 30 examples in mu corpus
...
\begin{exe}\let\eachwordone=\textnormal \let\eachwordtwo=\ve
	...
	\ex{\glll	[n͡maˈsenʊn \hp{=}{ɐmːɐ} ʔanmɐˈβanə \tbr{nβ}in \hspace{15mm} \hp{[}ɾɛ̰ʔ nanɐ̰ mɛsɛʔ]\\
