...
is itself an instance of dependent co-ordination (\srf{sec:DepCoo})
...
\begin{exe}
	...
	\begin{xlist}
		...
		\ex{\glll	areʔ siin baer fua-t=eni n-nonaʔ =sini =ma n-o\tbr{ut} =siin.\\
							...
							every {\siin} thing trad'.religion-{\at}={\ein\Uc} \n-hand{\Uc} ={\siin\U} =and \n-burn{\tbrM} ={\siin}\\
		...
		\ex{\glll	areʔ uim fua-t, uim reeʔgw=ee msaʔ a|n-pukai n-aan\j=ee, n-o\tbr{tu}\\
							areʔ umi fua-t umi reʔu=ee msaʔ {\a}n-pukai n-ani=ee n-otu.\\
							every house trad'.religion-{\at} house sacred={\ee} also {\a\n}-dismantle \n-before={\eeV} \n-burn{\tbrU}\\
		...
		\ex{\gll	henatiʔ, n-paek reʔ \sf{cara} reʔ ia,\\
...
\begin{exe}
	\sn{\begin{xlist}
		\exi{d.}{\glll	au ees a-na{\tl}nao-t. au ees a-tok{\tl}took \sf{sidaŋ}.\\
...
of the M-form and U-form forms of \ve{n-oka} `accompanies',
