...
\begin{exe}
	\ex{How the snake \it{Moo{\Q}hitu{\Q}} separated the sky from the land:
				\txrf{120715-4} {\emb{120715-4-00-25-00-27.mp3}{\spk{}}{\apl}}}\label{ex:120715-4, 0.25-0.27}
	\sn{\xytext{\fbox{stand{\U}\vp{|}}\xybarconnect[2][-](D,D){2}\xybarconnect[2][->]{4}&and&\fbox{rise{\M}\vp{|}}&when&\fbox{sky spread{\Uc}\vp{|}}}}
	\begin{xlist}
		...
		\ex{\glll	neeŋgw=ii na-tsiriʔ, na-tsiriʔ \sf{sampe} iin n-tea reʔ aat neno nee msaʔ iin na-tuin=ee =ma\\
				...
				\glt	`the sky spread (and) spread until until when he arrived at where the top of the sky also is, he followed it and' \txrf{0.30}}
	\end{xlist}
\end{exe}
...
\begin{exe}
	...
	\begin{xlist}
		...
		\ex{\glll	hoo m-bi reʔ nahen pooʔn=ee =te, \hspace{15mm} ʔ-\tbr{foro} ʔ-\tbr{mate} =m\\
		...
		\ex{\glll	ʔ-tae, ka= ʔ-\tbr{iit}, u-tunuʔ u-fain.\\
				...
				\glt	`I looked down at (it), couldn't see (it), (so I) put it back.' \txrf{}}\label{ex:130825-6, 9.14a}
...
The use of U-forms and M-forms and parallel verbs is discussed
