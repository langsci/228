...
\ve{uup kaʔo}	&	\ve{uup kaʔo-f}	&	CCC	&	`great-grandchild'\\
		...
		\begin{tablenotes}
			\item [†] \ve{kaʔo} `ancestor' and \ve{bitoroʔ} `mothers' brother
								...
								and the suffix \ve{-f}. \ve{nane-f} `duaghter in law'
...
\begin{exe}
	...
	\ex{\gll	hoo feat-\tbr{f}=ii bi sekau?\\
			...
			\glt	`Who's your sister?/What's your sisters name?'
...
In these examples \tsc{psr} is used for ``possessor'' and \tsc{psm}
...
arises from the suffix \ve{-r} marks the possessum \ve{haʔe}
