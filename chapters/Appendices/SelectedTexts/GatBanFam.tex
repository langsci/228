...
\exi{0.37}{\gll
		\sf{maam} Rosalin hini tuuhao-n=aa\\
...
\exi{0.41}{\glll
			na-ʔuab na-tuinaʔ siin moin-r=ini \hspace{3.5cm} n-oko ahh siin na͡{\i}ʔik siin amaʔ\\
			na-ʔuaba na-tuinaʔ sini moni-r=ini {} n-oko ahh sini naiʔik sini amaʔ\\
...
\exi{1.09}{\glll
		eti fuun tabu ai au nu ʔ-peo ku-tono=n hiit aan moon\j=ii kaes mutiʔ\\
		eti funan tabu ai au nu ʔ-peo ku-tona=n hiit anaʔ mone=ii kase mutiʔ\\
...
\exi{1.19}{\glll
		\sf{yaŋ} \sf{sebenarɲa} hai m-oko hai ruan=aa eseʔ {} ai\\
		\sf{yaŋ} \sf{sebenarɲa} hai m-oko hai ruan=aa esa heʔ ai\\
...
\exi{1.23}{\glll
		\sf{tetapi} et au \sf{bapa} siin manaʔ niim siin feotr=iin teun\\
...
\glt `My dad is the the youngest man.'}

\ex{\ve{Es naka͡uhub au bapa ek nakaf Niin-Ri{\Q}in}.}
\exi{1.36}{\glll
		ees na-kauhu-b au \sf{bapa} ek naka-f Niin-Riʔin\\
...
\exi{1.43}{\glll
		hai m-took ek naa \sf{sampai} toon boʔ esa =m hiut eee\\
		hai m-toko ek naa \sf{sampai} toon boʔ esa =m hitu eee\\
		{\hai} \m-sit {\ek} {\naa} until year ten one{\U} =and seven indeed\\
...
\exi{2.55}{\glll
		\sf{{\j}adi} heʔ hai ka-moin-t=ii hai m-took mi-baar ek nakaf Niin-Riʔin\\
...
\exi{3.25}{\glll
		hai oriʔ ees heʔ hoo aiʔ hai tataʔ eseʔ {} hoo \hspace{3cm} m-ook paha Australia\\
		hai oriʔ esa heʔ hoo aiʔ hai tataʔ esa heʔ hoo {} m-oko paah Australia\\
...
\exi{3.28}{\glll
		\sf{tetapi} mabeʔ ai hiit ta-teef anene-- ta-tuinaʔ ma-nere-t Uisneno\\
