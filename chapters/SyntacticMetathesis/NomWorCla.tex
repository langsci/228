...
\begin{exe}
	\ex{\gll	n-naaʔ \brac{OBJ} {\tbr{benas} \bracr{}} he n-nao =t, afi--{\ldots}\\
						\n-hold {} machete {\he} \n-go ={\te} yesterday\\
...
In example \qf{ex:160326, 10.06} below the object of the locational verb \ve{n-bi}
...
\begin{exe}
	...
	\ex{\gll	\tbr{hoo} \tbr{mu}-mnau fatu Brao=n konaʔ hiut?\\
						{\hoo} \mu-remember stone Brao={\ein} hole seven\\
...
marking the definiteness and topicality of a nominal phrase (see \srf{sec:FunDet} for more details).
...
\begin{exe}
	\ex{\gll	hoo m-ait\j=ee \sf{berarti} of hoo m-ait mu-faniʔ mapuutʔ=\tbr{ee}.\\
					%	hoo m-aiti=ee \sf{berarti} of hoo m-aiti mu-faniʔ maputuʔ=ee\\
						{\hoo} {\m}-take={\eeV} mean later {\hoo} {\m}-take {\mu}-repeat hot={\ee}\\
	...
	\ex{\gll	n-poi n-bi meotʔ=\tbr{ee} onai =te {\ldots}\\
...
Determiners in Amarasi occur attached to singular referents which
are known definite information.
...
The use of these determiners to mark known definite nominals
...
\begin{exe}
	...
	\begin{xlist}
		\ex{\gll hoo feat-f=\tbr{ii} bi sekau?\\
						...
						`Who is your sister?' \txrf{2.06}}\label{ex2:130825-6, 2.06}
