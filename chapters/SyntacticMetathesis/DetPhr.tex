...
\begin{exe}
	\ex{\glll	ne\tbr{no} \tbr{naa} paha{\gap}ʔpi\tbr{na}-\tbr{n} \tbr{ia}, \hspace{40mm} a|n-kobub on bare meseʔ.\\
	...
	\ex{\glll	nehh, baab Saraʔ n-nao et pa\tbr{ni}-\tbr{n} \tbr{nee}.\\
			...
			Well, Aunt Sarah had gone across there.'
	...
	\ex{\glll	of pa\tbr{paʔ} \tbr{naan} na-papaʔ \sf{terus}. \\
						...
						sure wound{\tbrU} {\naan} \na-wound constant\\
						`That wound will surely be a wound constantly.'
