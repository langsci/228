...
\begin{exe}
	...
	\ex{\glll ehh, n-fain=n=ena? naiʔ Rius iin\j=\tbr{ana} n-fani? \\
...
\begin{exe}
	...
	\ex{\begin{xlist}
		\ex{\gll	sekau iin=n=aa esa=n reʔ ia? \\
							who {\iin=\ein=\aa} {\esc}={\ein} {\req} {\ia} \\
				\glt `Whose (things) are these?'}
		\ex{\gll	hai=\tbr{nu}. \\
							{\hai=\ein} \\
				\glt	`(They're) ours'.
...
\begin{exe}
	...
	\ex{\glll	ʔ-ak ``hei, hoo \sf{kartu} =sina n-mate=n, baiʔ Kus, \hspace{10mm} au=\tbr{ŋgwein} n-moni=n.\\
...
\begin{exe}
	\ex{\gll	he mu-skoor m-ain =siin, mu-skoor m-ain siin okeʔ, hoo \tbr{ʔ}-\tbr{muiʔ}-\tbr{m}=ii saaʔ? \\
						{\he} {\mu}-school \m-before ={\siin} \mu-school \m-before siin all {\hoo} {\qq}-have-{\mg=\ii} what \\
	...
	\ex{\gll	\sf{taŋguŋ {\j}awab} saap=ii\j=aah, hita \tbr{ʔ}-\tbr{moni}-\tbr{k}, hita \tbr{ʔ}-\tbr{hake}-\tbr{k}, hita \tbr{ʔ}-\tbr{nao}-\tbr{k} eta krei =ma prenat.\\
						responsibility because={\ii=just} {\hiit} {\qq}-live-{\k} {\hiit} {\qq}-stand-{\k} {\hiit} {\qq}-go-{\k} {\et} church =and government\\
			\glt	`Just because of this responsibility, it is our life, our standing, our way in the Church and government.'
...
The structure of the possessive phrase is indicated in \qf{tr:PossP} below.
...
\newpage
\begin{exe}
	\ex{\gll	hoo m-reaʔ \tbr{atoniʔ} fu-- \tbr{roa}-\tbr{t}=\tbr{aa} \tbr{fua}-\tbr{n} =at \sf{berarti} naan\\
...
\begin{exe}
	\ex{\glll	\tbr{bi} \tbr{Esi} \tbr{iin\j}=\tbr{ee} msaʔ iin n-tee Malesia.\\
						bi Esi ini=ee msaʔ ini n-tea Malesia\\
