...
\begin{exe}
	\ex{\glll ʔ-meup ʔ-aan, nehh, ume, u\tbr{me} \tbr{boʔ}=\tbr{ees}, \sf{termasuk} hiit ume.\\
						...
						I worked on houses, ten houses, including our house.'
						\txrf{130907-3, 3.41} {\emb{130907-3-03-41.mp3}{\spk{}}{\apl}}\vspace{-12pt}}\label{ex:130907-3, 3.41}
	...
	\ex{\glll	saap n-ak no\tbr{noʔ} \tbr{seo}, a|n-poi na-raar\j=oo-k =te, oekʔ=een.\\
...
A combination of a nominal and numeral can also occur as the head of a number phrase.
Such nominal and numeral combinations indicate measurements.
...
\begin{exe}
	...
	\ex{\glll	ʔ-ak ``ehh, au rookgw=ii a\tbr{ra} \tbr{nonoʔ} \tbr{meseʔ}  =t,\\
						{\q}-ak {} au roko=ii ara nonoʔ meseʔ =te\\
						{\q}-ak \hp{``}hey {\au} cigarette={\ii} rest{\tbrU} rod{\U} one ={\te}\\
...
are given in \qf{ex:130825-8, 1.41 ch:PhoMet}--\qf{ex:130909-6, 3.16} below.
...
\begin{exe}
	\ex{\gll	ʔ-fei kraan=\tbr{ees}=\tbr{ii} =ma ʔ-toroʔ, ohh.\\
			...
			\glt	`I turned on one of the taps and tested, ohh.'
						\txrf{130825-8, 1.41} {\emb{130825-8-01-41.mp3}{\spk{}}{\apl}}}\label{ex:130825-8, 1.41 ch:PhoMet}
	\ex{\gll	taaʔ\j=\tbr{ees}=\tbr{ii} mutiʔ.\\
						branch=\tbr{\es}=\tbr{\ii} white \\
			\glt	`One of the branches was white.'
						\txrf{130823-2, 0.49} {\emb{130823-2-00-49.mp3}{\spk{}}{\apl}}}%\label{ex:130823-2, 0.49 ch:PhoMet}
\end{exe}
\newpage
\begin{exe}
...
\begin{exe}
	\ex{\glll	\sf{lantas,} na-ʔko reʔ \tbr{tua} \tbr{haaʔ}=\tbr{ein} reʔ ia, \hspace{20mm} siin na-honi n-teinʔ=ein =ama,\\
	...
	\ex{\glll	\tbr{kua} \tbr{hiut-ʔ}=\tbr{ein} naan, au ʔ-tea ʔ-rair.\\
						kua\tbr{n} hitu-ʔ=eni naan au ʔ-tea ʔ-rari\\
						village{\tbrM} seven-{\qnum}={\ein} {\naan} {\au} \q-up.to \q-finish\\
			\glt	`Those seven villages, I've already been to.'
